var canvas = document.getElementById("PJS_Buffer"); 
var sketchProc = function(processingInstance) {
with (processingInstance) {
    size(600, 600); 
    
    var newUintArray, atob, DecodeStream, FlateStream, PNG;
    function initPNGLib(){
    ...
    function loadIMG(imgToLoad){
      var temp = new PNG(atob(imgToLoad)).toImage();
      image(temp, 0, 0);
      return document.getElementById("PJS_Buffer").getContext('2d').getImageData(0, 0, temp.width, temp.height);
    }
    
    crateIMG = loadIMG(crateIMG);
    dirt_plainIMG = loadIMG(dirt_plainIMG);
    dirt_1IMG = loadIMG(dirt_1IMG);
    dirt_2IMG = loadIMG(dirt_2IMG);
    dirt_3IMG = loadIMG(dirt_3IMG);
    fenceIMG = loadIMG(fenceIMG);
